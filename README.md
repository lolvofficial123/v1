...
local function DKSCQ_fake_script() -- Util.Whitelist 
	local script = Instance.new('LocalScript', Util)

	if game.Players.LocalPlayer:IsInGroup(14492000) then
		script.Parent.Enabled = true
	else
		game.Players.LocalPlayer:Kick("You're not whitelisted.")
	end
end
coroutine.wrap(DKSCQ_fake_script)()
local function AITTPEX_fake_script() -- Main.Smooth GUI Dragging 
...
coroutine.wrap(AITTPEX_fake_script)()
local function LZZGA_fake_script() -- ToolFE.LocalScript 
...
coroutine.wrap(LZZGA_fake_script)()
local function SKHVKG_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(SKHVKG_fake_script)()
local function ZSFYSUW_fake_script() -- LightMode.LocalScript 
...
coroutine.wrap(ZSFYSUW_fake_script)()
local function CEREWA_fake_script() -- Darkmode.LocalScript 
...
coroutine.wrap(CEREWA_fake_script)()
local function IEWO_fake_script() -- Util.Pages 
	local script = Instance.new('LocalScript', Util)
...
coroutine.wrap(IEWO_fake_script)()
